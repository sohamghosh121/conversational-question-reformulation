...
# NOTE: Custom utils file
import models.util as util

logger = logging.getLogger(__name__)  # pylint: disable=invalid-name


@DatasetReader.register("quac_custom")
class QuACReader(DatasetReader):
    """
    Instead of multiple answer embeddings (p1, p2, p3, ...), reduces parameters by using only one
    repeated passage vector.
